...
# python merge_smplh_mano.py --smplh-fn ../SMPL_models/smplh/SMPLH_MALE.pkl \
#  --mano-left-fn ../SMPL_models/smplh_o/MANO_LEFT.pkl \
#  --mano-right-fn ../SMPL_models/smplh_o/MANO_RIGHT.pkl \
#  --output-folder ../SMPL_models/smplh/
